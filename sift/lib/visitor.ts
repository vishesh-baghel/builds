...
/**
 * An opaque browser id, not a person. It exists only so one visitor's allowance is not another's:
 * it is linked to nothing, and the only thing ever written against it is a count of calls.
 */
export const VISITOR_COOKIE = "sift_vid";
